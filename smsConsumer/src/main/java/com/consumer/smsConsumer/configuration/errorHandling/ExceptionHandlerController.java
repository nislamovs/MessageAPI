package com.consumer.smsConsumer.configuration.errorHandling;


import com.consumer.smsConsumer.domain.exceptions.VonageTokenAuthException;
import com.consumer.smsConsumer.domain.responses.ErrorResponse;
...
public class ExceptionHandlerController {
    ...
    @ExceptionHandler({
            VonageTokenAuthException.class,
            Exception.class})
